...
The easiest way to get a OpenG2P-ng server is by using Newlogic's Cloud.
...
By choosing Newlogic Cloud, you are also directly supporting future development on OpenG2P-ng and helping make
...
Amazon Web Services (AWS) is one of the many other options for installing OpenG2P-ng. It's a good idea to read
...
Before installing OpenG2P-ng on your server, you need to install Docker and Docker Compose. Follow the
instructions below.
